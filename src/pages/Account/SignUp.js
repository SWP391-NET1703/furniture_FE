        ...
        {successMsg ? (
          <div className="w-full max-w-[500px] mx-auto">
            ...
            <Link to="/signin">
              <button
                className="w-full h-10 bg-primeColor rounded-md text-gray-200 text-base font-titleFont font-semibold 
              tracking-wide hover:bg-black hover:text-white duration-300 mx-auto">
                Sign in
              </button>
            </Link>
          </div>
          ...
          <form
            ...
            <div className="px-6 py-4 w-full flex flex-col justify-start overflow-y-auto scrollbar-thin scrollbar-thumb-primeColor">
              ...
              <div className="flex flex-col gap-3">
                ...
                <button
                  type="submit"
                  className="w-full text-gray-200 text-base font-medium h-10 rounded-md bg-primeColor hover:bg-black hover:text-white duration-300">
                  Create Account
                </button>
                <p className="text-sm text-center font-titleFont font-medium">
                  Don't have an Account?{" "}
